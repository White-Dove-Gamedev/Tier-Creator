...
Moved version to Release.

## [0.26.1]

### Fixed

Crash when saving a template where cards have no textures.
...
Increased CardBench Height by 2.5 in the TierCreator Scene.
...
Game Icon. Will change it later.

### Fixed

Incorrect window scaling.
...
ColorPickerButton for the SettingsWindow

### Removed

LineEdit for picking colors in favour of the ColorPickerButton
